 ...
 * @author Luis
 */
public class EliminarAlmacen extends javax.swing.JPanel {

    private DefaultTableModel modelo;

    /**
     * Creates new form EliminarAlmacen
     */
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(449, 323));
        setMinimumSize(new java.awt.Dimension(449, 323));
        ...
        jLabel1.setText("Para eliminar un Almacen seleccionalo y con click derecho -> eliminar");

        jButton1.setText("Recargar Almacenes");
    ...
    private void Eliminar(int Clave) {
        try {
            Sql.SqlQuery(Sql.connection, "DELETE FROM almacen WHERE clave=" + Clave);
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
        }
    }
