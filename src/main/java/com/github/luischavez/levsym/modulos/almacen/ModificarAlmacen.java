 ...
 * @author Luis
 */
public class ModificarAlmacen extends javax.swing.JPanel {

    private DefaultTableModel modelo;

    /**
     * Creates new form ModificarAlmacen
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para editar un Almacen da doble click en el Almacen");

        jButton1.setText("Recargar Almacen");
    ...
    private void Cargar() {
        try {
            ...
            ResultSet SqlQuery = Sql.SqlQuery(Sql.connection, "SELECT * FROM almacen");
    ...
    public void Editar(int Clave) {
        try {
            ResultSet SqlQuery = Sql.SqlQuery(Sql.connection, "SELECT * FROM almacen WHERE clave=" + Clave);
            int columnCount = SqlQuery.getMetaData().getColumnCount();
            if (SqlQuery.next()) {
                Object[] Row = new Object[columnCount];
                ...
                MainFrame.Window(new NuevoAlmacen(Row), "Modificar Almacen - " + SqlQuery.getString(2), 420, 290, 0);
            }
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
        }
