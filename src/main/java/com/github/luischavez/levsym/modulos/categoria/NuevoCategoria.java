 ...
 * @author Luis
 */
public class NuevoCategoria extends javax.swing.JPanel {
    ...
    public NuevoCategoria(Object[] Item) {
        initComponents();
        Operacion = 1;
    ...
    private void Update(Object[] Entry) {
        try {
            ...
            switch (Operacion) {
                case 0:
                    SqlQueryStmts = Sql.SqlQueryStmts(Sql.connection, "INSERT INTO categoria VALUES (?,?,?)");
                    SqlQueryStmts.setNull(1, java.sql.Types.INTEGER);
                    break;
                case 1:
                    SqlQueryStmts = Sql.SqlQueryStmts(Sql.connection, "UPDATE categoria SET"
                            + " clave = ? "
                            + ", nombre = ? "
                            + ", descripcion = ? "
