...
public class EliminarCliente extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para eliminar un Cliente seleccionalo y con click derecho -> eliminar");

        jButton1.setText("Recargar Clientes");
    ...
    private void Eliminar(int Clave) {
        try {
            Sql.SqlQuery(Sql.connection, "DELETE FROM clientes WHERE clave=" + Clave);
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
        }
    }
