...
public class ModificarCliente extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para editar un Cliente da doble click en el Cliente");
    ...
    public void Editar(int Clave) {
        try {
            ...
            if (SqlQuery.next()) {
                ...
                MainFrame.Window(new NuevoCliente(Row), "Modificar Cliente - " + SqlQuery.getString(2), 410, 450, 0);
            }
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
        }
