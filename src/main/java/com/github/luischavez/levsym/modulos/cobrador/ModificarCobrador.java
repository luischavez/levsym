 ...
 * @author Luis
 */
public class ModificarCobrador extends javax.swing.JPanel {

    private DefaultTableModel modelo;

    /**
     * Creates new form ModificarCobrador
     */
    public ModificarCobrador() {
        initComponents();
        Cargar();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para editar un Cobrador da doble click en el Cobrador");
    ...
    public void Editar(int Clave) {
        try {
            ResultSet SqlQuery = Sql.SqlQuery(Sql.connection, "SELECT * FROM cobradores WHERE clave=" + Clave);
            int columnCount = SqlQuery.getMetaData().getColumnCount();
            if (SqlQuery.next()) {
                Object[] Row = new Object[columnCount];
                ...
                MainFrame.Window(new NuevoCobrador(Row), "Modificar Cobrador - " + SqlQuery.getString(2), 420, 160, 0);
            }
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
        }
