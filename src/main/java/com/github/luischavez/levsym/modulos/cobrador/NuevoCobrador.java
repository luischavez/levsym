 ...
 * @author Luis
 */
public class NuevoCobrador extends javax.swing.JPanel {

    private TitledBorder t;
    private int Operacion = 0;

    /**
     * Creates new form NuevoCobrador
     */
    ...
    public NuevoCobrador(Object[] Item) {
        initComponents();
        Operacion = 1;
    ...
    private void Update(Object[] Entry) {
        try {
            ...
            switch (Operacion) {
                case 0:
                    SqlQueryStmts = Sql.SqlQueryStmts(Sql.connection, "INSERT INTO cobradores VALUES (?,?)");
                    SqlQueryStmts.setNull(1, java.sql.Types.INTEGER);
                    break;
                case 1:
                    SqlQueryStmts = Sql.SqlQueryStmts(Sql.connection, "UPDATE cobradores SET"
                            + " clave = ? "
                            + ", nombre = ? "
