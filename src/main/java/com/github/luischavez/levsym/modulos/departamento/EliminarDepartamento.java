 ...
 * @author Luis
 */
public class EliminarDepartamento extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para eliminar un Departamento seleccionalo y con click derecho -> eliminar");
    ...
    private void Eliminar(int Clave) {
        try {
            Sql.SqlQuery(Sql.connection, "DELETE FROM departamento WHERE clave=" + Clave);
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
        }
    }
