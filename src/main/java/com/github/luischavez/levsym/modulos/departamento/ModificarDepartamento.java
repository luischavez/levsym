 ...
 * @author Luis
 */
public class ModificarDepartamento extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para editar un Departamento da doble click en el Departamento");

        jButton1.setText("Recargar Departamentos");
    ...
    public void Editar(int Clave) {
        try {
            ResultSet SqlQuery = Sql.SqlQuery(Sql.connection, "SELECT * FROM departamento WHERE clave=" + Clave);
            int columnCount = SqlQuery.getMetaData().getColumnCount();
            if (SqlQuery.next()) {
                Object[] Row = new Object[columnCount];
                ...
                MainFrame.Window(new NuevoDepartamento(Row), "Modificar Departamento - " + SqlQuery.getString(2), 420, 290, 0);
            }
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
        }
