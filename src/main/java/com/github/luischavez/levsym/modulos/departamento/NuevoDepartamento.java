 ...
 */
package com.github.luischavez.levsym.modulos.departamento;
 ...
 * @author Luis
 */
public class NuevoDepartamento extends javax.swing.JPanel {
    ...
    public NuevoDepartamento(Object[] Item) {
        initComponents();
        Operacion = 1;
    ...
    private void Update(Object[] Entry) {
        try {
            ...
            switch (Operacion) {
                case 0:
                    SqlQueryStmts = Sql.SqlQueryStmts(Sql.connection, "INSERT INTO departamento VALUES (?,?,?)");
                    SqlQueryStmts.setNull(1, java.sql.Types.INTEGER);
                    break;
                case 1:
                    SqlQueryStmts = Sql.SqlQueryStmts(Sql.connection, "UPDATE departamento SET"
                            + " clave = ? "
                            + ", nombre = ? "
                            + ", descripcion = ? "
