...
public class RealizarPago extends javax.swing.JPanel {
    ...
    public RealizarPago(Object[] Item, Object[] Item2) {
        initComponents();
    ...
    private void EstadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EstadoMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            int selectedRow = Estado.getSelectedRow();
            if (selectedRow >= 0) {
                Object valueAt = Estado.getValueAt(selectedRow, 3);
                if (valueAt.toString().equals("0")) {
                    Double Cantidad = Double.valueOf(SaldoInicial.getText()) / Integer.valueOf(Tabla[11].toString());
                    int showConfirmDialog = JOptionPane.showConfirmDialog(this, "Desea realizar el pago de " + Cantidad + " Pesos", "Pagar?", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null);
                    if (showConfirmDialog == 0) {
                        Object[] Row = new Object[Estado.getColumnCount()];
                        for (int x = 0; x < Estado.getColumnCount(); x++) {
                            Row[x] = Estado.getValueAt(selectedRow, x);
                        }
                        Row[3] = Cantidad;
                        Update(Row);
                    }
