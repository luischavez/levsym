...
public class EliminarProducto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(438, 323));
        setMinimumSize(new java.awt.Dimension(438, 323));
        ...
        jLabel1.setText("Para eliminar un producto seleccionalo y con click derecho -> eliminar");
    ...
    private void Eliminar(int Clave) {
        try {
            Sql.SqlQuery(Sql.connection, "DELETE FROM productos WHERE clave=" + Clave);
            Sql.Clear();
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
        }
