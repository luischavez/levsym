...
public class ModificarProducto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para editar un producto da doble click en el producto que quieres");

        jButton1.setText("Recargar Productos");
    ...
    public void Editar(int Clave) {
        try {
            ResultSet SqlQuery = Sql.SqlQuery(Sql.connection, "SELECT * FROM productos WHERE clave=" + Clave);
            int columnCount = SqlQuery.getMetaData().getColumnCount();
            if (SqlQuery.next()) {
                Object[] Row = new Object[columnCount];
                ...
                MainFrame.Window(new NuevoProducto(Row), "Modificar Producto - " + SqlQuery.getString(2), 400, 510, 0);
            }
            Sql.Clear();
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
