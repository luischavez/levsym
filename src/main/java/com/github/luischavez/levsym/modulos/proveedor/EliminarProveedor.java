...
public class EliminarProveedor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para eliminar un proveedor seleccionalo y con click derecho -> eliminar");
    ...
    private void Eliminar(int Clave) {
        try {
            Sql.SqlQuery(Sql.connection, "DELETE FROM proveedor WHERE clave=" + Clave);
            Sql.Clear();
        } catch (SQLException ex) {
            Log.SaveLog(ex.toString());
        }
