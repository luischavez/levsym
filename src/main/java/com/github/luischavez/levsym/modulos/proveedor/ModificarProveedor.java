...
public class ModificarProveedor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para editar un proveedor da doble click en el proveedor que quieres");

        jButton1.setText("Recargar Proveedores");
    ...
    private void Editar(int Clave) {
        try {
            ResultSet SqlQuery = Sql.SqlQuery(Sql.connection, "SELECT * FROM proveedor WHERE clave=" + Clave);
            ...
            if (SqlQuery.next()) {
                ...
                MainFrame.Window(new NuevoProveedor(Row), "Modificar Proveedor - " + SqlQuery.getString(2) + " " + SqlQuery.getString(3) + " " + SqlQuery.getString(4), 390, 580, 0);
            }
            Sql.Clear();
