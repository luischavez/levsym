...
public class ModificarVendedor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(426, 323));
        setMinimumSize(new java.awt.Dimension(426, 323));
        ...
        jLabel1.setText("Para editar un Vendedor da doble click en el Vendedor que quieres");

        jButton1.setText("Recargar Vendedor");
    ...
    private void Editar(int Clave) {
        try {
            ResultSet SqlQuery = Sql.SqlQuery(Sql.connection, "SELECT * FROM vendedor WHERE clave=" + Clave);
            ...
            if (SqlQuery.next()) {
                ...
                MainFrame.Window(new NuevoVendedor(Row), "Modificar Vendedor - " + SqlQuery.getString(2), 420, 160, 0);
            }
            Sql.Clear();
    ...
    private void Cargar() {
        try {
            ...
            ResultSet SqlQuery = Sql.SqlQuery(Sql.connection, "SELECT * FROM vendedor");
            int columnCount = SqlQuery.getMetaData().getColumnCount();
