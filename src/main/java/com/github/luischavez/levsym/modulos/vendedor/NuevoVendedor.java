 ...
 */
package com.github.luischavez.levsym.modulos.vendedor;
 ...
 * @author Luis
 */
public class NuevoVendedor extends javax.swing.JPanel {
    ...
    public NuevoVendedor(Object[] Item) {
        initComponents();
        Operacion = 1;
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(400, 137));
    ...
    private void Update(Object[] Entry) {
        try {
            ...
            switch (Operacion) {
                case 0:
                    SqlQueryStmts = Sql.SqlQueryStmts(Sql.connection, "INSERT INTO vendedor VALUES (?,?)");
                    SqlQueryStmts.setNull(1, java.sql.Types.INTEGER);
                    break;
                case 1:
                    SqlQueryStmts = Sql.SqlQueryStmts(Sql.connection, "UPDATE vendedor SET"
                            + " clave = ? "
                            + ", nombre = ? "
